			...
			timetable.forEach(function(values, index) {
				...
				values.forEach(function(item, i) {
					...
					if(merge && listMerge[i][index].length > 1) {
						...
						mergeDom.style.width = "95%";
						mergeDom.style.height = Gheight * listMerge[i][index].length + "px";
						mergeDom.style.left = "2.5%";
						mergeDom.style.top = 0;
						mergeDom.style.border = "1px solid black;";
						if(palette) {
							
//							mergeDom.style.backgroundColor = palette[paletteIndex];
							if(parseInt(listMerge[i][index].name.split("/")[1])<6){
								mergeDom.style.backgroundColor= "#8AFD8C";
								mergeDom.style.color = "#000";
								mergeDom.className = "course-hasContent aaaa";
							}else{
								mergeDom.style.backgroundColor= "#999999";
								mergeDom.style.color = "red";
								mergeDom.className = "course-hasContent bbbb";
							}
						...
						mergeDom.innerText = listMerge[i][index].name.split('/')[1]+"人（"+listMerge[i][index].name.split('/')[2]+"）";
						if(mergeDom.innerText.indexOf("试听课")>=0){
							mergeDom.style.backgroundColor = "#EFEA38";
						}else if(mergeDom.innerText.indexOf("常规课")>=0){
							mergeDom.style.backgroundColor = "#1EB9EF";
						}else if(mergeDom.innerText.indexOf("赛事课")>=0){
							mergeDom.style.backgroundColor = "#E70012";
						}else if(mergeDom.innerText.indexOf("活动课")>=0){
							mergeDom.style.backgroundColor = "#8FC320";
						}
