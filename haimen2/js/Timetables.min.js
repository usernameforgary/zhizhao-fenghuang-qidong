			...
			timetable.forEach(function(values, index) {
				...
				values.forEach(function(item, i) {
					...
					if(merge && listMerge[i][index].length > 1) {
						...
						mergeDom.innerText = listMerge[i][index].name.split("&")[0];
						if(mergeDom.innerText.indexOf("试听课")>=0){
							mergeDom.style.backgroundColor = "#FFC85E";
					...
					courseItem.onclick = function(e) {
						var allList = $(".Courses-content ul li").each(function(v, i) {
							$(v).removeClass("grid-active")
						});
