...
function selectP(p) {
	...
	areaList.html(areaCont);
	$("#areaBox").scrollTop(0);
	expressArea = province[p] + " <i class='iconfont icon-iconfontyoujiantou' style='font-size: 0.3rem;color: #BBBEC3;'></i> ";
...
function selectC(p,c) {
	...
	if (sCity != "省直辖县级行政单位") {
		if (sCity == "东莞市" || sCity == "中山市" || sCity == "儋州市" || sCity == "嘉峪关市") {
			...
			expressArea += sCity + " <i class='iconfont icon-iconfontyoujiantou' style='font-size: 0.3rem;color: #BBBEC3;'></i> ";
		}
	}
